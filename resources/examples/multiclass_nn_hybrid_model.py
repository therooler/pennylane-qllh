...
from resources.model.nn_hybrid_model import HybridNNModel, HybridNNModelWrapper
...
def multiclass_hybrid_nn():
    ...
    model = HybridNNModel(nclasses=3, dev_name="default.qubit")
    wrapper = HybridNNModelWrapper(model)
    ...
    wrapper.train(X, y, maxiter=250, epsilon=0.001, tol=10e-6)
